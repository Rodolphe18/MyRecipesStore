...
object RepositoryModule {
    ...
    ): SearchRepository = SearchRepositoryImpl(homeRepository, offlineSearchRepository, userDataRepository)
    ...
    fun provideLikeableFullRecipeRepository(
        ...
        userDataRepository: UserDataRepository,
    ): FullRecipeRepository = FullRecipeRepositoryImpl(offlineFullRecipeData, userDataRepository)
    ...
    fun provideOfflineFirstFavoritesRepository(
        ...
        dao: FullRecipeDao,
        userDataRepository: UserDataRepository,
    ): OfflineFirstFavoritesRepository = OfflineFirstFavoritesRepositoryImpl(api, dao, userDataRepository)
    ...
    fun provideHomeRepository(
        homeRepository: OfflineFirstHomeRepository,
        userDataRepository: UserDataRepository,
    ): HomeRepository = HomeRepositoryImpl(homeRepository, userDataRepository)
