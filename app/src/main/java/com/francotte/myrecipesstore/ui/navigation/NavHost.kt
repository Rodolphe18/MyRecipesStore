...
fun NavHost(
    ...
    NavHost(
        ...
        favoritesScreen(onToggleFavorite = {}, onOpenRecipe = navController::navigateToDetailRecipeScreen, recipeDetailDestination = {detailRecipeScreen(onBackClick = navController::popBackStack)})
    }
}
